    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">
                <%--&copy; 版权所有 <span class="tip"><a href="http://www.jeewx.com" target="_blank" title="捷微JeeWx：免费开源微信公众账号开发平台">捷微JeeWx</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a href="http://www.jeecg.org" target="_blank" title="JEECG开源社区">JEECG 开源社区</a> </span>--%>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
